...
|:---:|:---|
| 📋 | [Описание](#-описание) |
| 🔐 | [1. Авторизация и регистрация пользователей](#1--авторизация-и-регистрация-пользователей) |
| 📝 | [2. Необходимые формы авторизации](#2--необходимые-формы-авторизации) |
| 📤 | [3. Необходимые формы добавления данных](#3--необходимые-формы-добавления-данных) |
| ✅ | [4. Требования предъявляемые к формам](#4--требования-предъявляемые-к-формам) |
| 📊 | [Итоговая таблица форм](#-итоговая-таблица-форм) |
| 🔒 | [Декораторы и защита](#-декораторы-и-защита) |
| 💡 | [Работа с сессиями](#-работа-с-сессиями) |
| ✨ | [Особенности реализации](#-особенности-реализации) |
| 🚀 | [Использованные технологии](#-использованные-технологии) |
| 📝 | [Шпаргалка по часто используемому коду](#-шпаргалка-по-часто-используемому-коду) |
